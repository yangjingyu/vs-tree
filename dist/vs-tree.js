  ...
  var Tree = /*#__PURE__*/function () {
    function Tree(selector, ops) {
      ...
      var _ref = ops.virtual || {},
          ...
          maxHeight = _ref$maxHeight === void 0 ? '400px' : _ref$maxHeight; // 每一项的高度
      ...
      this.maxHeight = maxHeight; // 当前可见列表
    ...
    _createClass(Tree, [{
      ...
      value: function _render() {
        ...
        if (this.$$breadcrumb) {
          var current = this.$$breadcrumb.current; // this.store.breadcrumbs[this.store.breadcrumbs.length - 1]

          this.data = this.nodes.filter(function (v) {
            return v.parent && v.parent.data.id === current.data.id;
          });
