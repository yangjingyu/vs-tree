...
var TreeStore = /*#__PURE__*/function () {
  ...
  _createClass(TreeStore, [{
    ...
    value: function getCheckedNodes() {
      ...
      var isTreeNode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      ...
      if (this.sort) {
        ...
        return sortNodes.map(function (v) {
          return v.data;
        });
      }
...
var Tree = /*#__PURE__*/function () {
  function Tree(selector, ops) {
    ...
    var start = function start() {
      ...
      _this.store = new TreeStore({
        ...
        lazy: ops.lazy || false,
        sort: ops.sort || false,
        indent: (_ops$indent = ops.indent) !== null && _ops$indent !== void 0 ? _ops$indent : 10,
  ...
  _createClass(Tree, [{
    ...
    key: "_keywordFilter",
    value: function _keywordFilter(data) {
      var _this2 = this;

      this.data = data.filter(function (v) {
        // 过滤隐藏节点 ｜ 隐藏root节点
    ...
    value: function getCheckedNodes() {
      ...
      return (_this$store = this.store).getCheckedNodes.apply(_this$store, arguments);
    } // 设置最大可选
    ...
    key: "clearCheckedNodes",
    value: function clearCheckedNodes() {
